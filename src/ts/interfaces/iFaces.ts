...
export type TranslationKey =
	...
	| "notByAiMessage.message"
	| "getFavorites.message"
	| "actionHint.message"
	| "infoInitial.message"
	| "duplicatesFound.message"
	| "oneDuplicateFound.message"
	| "noDuplicates.message"
	| "successDeletion.message"
	| "confirmDelete.message"
	| "searchEmptyFolders.message"
	| "emptyFoldersRemoved.message"
	| "noEmptyFolders.message"
